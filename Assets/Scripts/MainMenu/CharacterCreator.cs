...
public class CharacterCreator : MonoBehaviour
{
    ...
    #region Asset parts
    [Header("All Gender Parts")]
    [SerializeField] private GameObject[] _headCoverings;
    [SerializeField] private GameObject[] _hair;
    [SerializeField] private GameObject[] _headAttachment;

    [SerializeField] private GameObject[] _backAttachment;
    [SerializeField] private GameObject[] _chestAttachment;
    [SerializeField] private GameObject[] _shoulderAttachmentRight;
    [SerializeField] private GameObject[] _shoulderAttachmentLeft;
    [SerializeField] private GameObject[] _elbowAttachmentRight;
    [SerializeField] private GameObject[] _elbowAttachmentLeft;
    [SerializeField] private GameObject[] _hipsAttachment;
    [SerializeField] private GameObject[] _kneeAttachmentRight;
    [SerializeField] private GameObject[] _kneeAttachmentLeft;
    [SerializeField] private GameObject[] _extra;

    [Header("Female Parts")]
    [SerializeField] private GameObject[] _femaleHead;
    [SerializeField] private GameObject[] _femaleEyebrows;
    [SerializeField] private GameObject[] _femaleFacialHair;
    [SerializeField] private GameObject[] _femaleTorso;
    [SerializeField] private GameObject[] _femaleUpperRightArm;
    [SerializeField] private GameObject[] _femaleUpperLeftArm;
    [SerializeField] private GameObject[] _femaleLowerRightArm;
    [SerializeField] private GameObject[] _femaleLowerLeftArm;
    [SerializeField] private GameObject[] _femaleRightHand;
    [SerializeField] private GameObject[] _femaleLeftHand;
    [SerializeField] private GameObject[] _femaleHips;
    [SerializeField] private GameObject[] _femaleLegRight;
    [SerializeField] private GameObject[] _femaleLegLeft;

    [Header("Male Parts")]
    [SerializeField] private GameObject[] _maleHead;
    [SerializeField] private GameObject[] _maleEyebrows;
    [SerializeField] private GameObject[] _maleFacialHair;
    [SerializeField] private GameObject[] _maleTorso;
    [SerializeField] private GameObject[] _maleUpperRightArm;
    [SerializeField] private GameObject[] _maleUpperLeftArm;
    [SerializeField] private GameObject[] _maleLowerRightArm;
    [SerializeField] private GameObject[] _maleLowerLeftArm;
    [SerializeField] private GameObject[] _maleRightHand;
    [SerializeField] private GameObject[] _maleLeftHand;
    [SerializeField] private GameObject[] _maleHips;
    [SerializeField] private GameObject[] _maleLegRight;
    [SerializeField] private GameObject[] _maleLegLeft;
    #endregion
    ...
    public void SelectGender(Gender genderInput)
    {
        gender = genderInput;
    ...
    public void SelectRace(Race raceInput)
    {
        race = raceInput;
    ...
    public void SelectSkinColor(SkinColor skinColorInput)
    {
        skinColor= skinColorInput;
    }

    public void IncrementHeadCovering(int increment)
    {
        //ActivateItem(allGender.headCoverings_Base_Hair)
    }
