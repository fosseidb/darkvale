...
public class vThirdPersonCamera : MonoBehaviour
{
    ...
    [Tooltip("Toggle if cursor is locked by default.")]
    ...
    /// <summary>
    /// Toggles the camera curos lock state
    /// </summary>
    /// <param name="lockCursor"></param>
    public void ToggleCameraLock(bool lockCursor)
    {
        if (lockCursor)
